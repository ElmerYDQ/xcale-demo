...
public class CustomResponseExceptionHandler {
  ...
  protected BodyErrorResponse handleMissingServletRequestParameter(
  ...
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  protected BodyErrorResponse handleUnsatisfiedServletRequestParameter(
  ...
  protected BodyErrorResponse handleHttpRequestMethodNotSupported(
  ...
  protected BodyErrorResponse handleHttpMediaTypeNotSupported(
  ...
  protected BodyErrorResponse handleMethodArgumentNotValid(MethodArgumentNotValidException ex) {
    ...
    BodyErrorResponse bodyErrorResponse =
        new BodyErrorResponse(HttpStatus.BAD_REQUEST, message, ex);
  ...
  protected BodyErrorResponse handleNoHandlerFoundException(NoHandlerFoundException ex) {
    String message =
        String.format(
            "No se pudo encontrar el método '%s' para la URL '%s'",
  ...
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  protected BodyErrorResponse handleMethodArgumentTypeMismatch(
      MethodArgumentTypeMismatchException ex) {
    String message =
        String.format(
            "El parámetro '%s' de valor '%s' no puede ser convertido al tipo '%s'",
